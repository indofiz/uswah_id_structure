...
export default function SIPGPage() {
  const productData = DataProviderFactory.createSIPGProvider().getData();
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ProductBenefits
        ...
        institutionBenefits={[]}
        userBenefitsTitle="Kemudahan untuk Pengguna"
        userBenefitsDescription="Pengalaman booking gedung yang mudah, cepat, dan terintegrasi untuk kebutuhan acara Anda"
      />
